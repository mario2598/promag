...
<div class="main-content">
  ...
  <section class="section">
          ...
          <div class="row" style="width: 100%">
            <div class="col-sm-12 col-md-2">
              <div class="form-group">
                <a class="btn btn-primary" title="Agregar Impuesto" style="color:white;" onclick="nuevoGenerico()">+ Agregar</a>
              </div>
            </div>
              ...
              <table class="table table-striped" id="">
                <thead>
                  <tr>
                    ...
                    <th class="space-align-center">Porcentaje de impuesto %</th>
                    <th class="space-align-center">Acciones</th>
                   
                  </tr>
                </thead>
                <tbody id="tbody_generico">
                  @foreach($data['impuestos'] as $g)
                <tr>
                  ...
                  <td class="space-align-center" >
                    <a onclick='editarGenerico("{{$g->id}}","{{$g->descripcion ?? ""}}","{{$g->impuesto ?? "0"}}")'  title="Editar" class="btn btn-primary" style="color:white"><i class="fas fa-cog"></i></a> 
    ...
    <form id="frmEliminarGenerico" action="{{URL::to('eliminarimpuesto')}}"  style="display: none" method="POST" >
      {{csrf_field()}}
...
aria-labelledby="mySmallModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="{{URL::to('guardarimpuesto')}}"  autocomplete="off" method="POST" >
            {{csrf_field()}}
            ...
            <div class="modal-header">
              ...
              <div class="spinner-border" id='modal_spinner' style='margin-right:3%;display:none;' role="status"></div>
                <h5 class="modal-title mt-0" id="edit_cliente_text"><i class="fas fa-cog"></i> Impuesto</h5>
                  ...
                  <div class="col-xl-12 col-sm-12">
                    <div class="form-group form-float">
                      <div class="form-line">
                        ...
                        <input type="text" class="form-control space_input_modal" id="mdl_generico_ipt_descripcion" name="mdl_generico_ipt_descripcion" required maxlength="50">
                      </div>
                  </div>
                  </div>
                  <div class="col-xl-12 col-sm-12">
                      <div class="form-group form-float">
                          <div class="form-line">
                          <label class="form-label">Porcentaje impuesto %</label>
...
@section('script')
  ...
  <script src="{{asset("assets/js/mant_impuestos.js")}}"></script>

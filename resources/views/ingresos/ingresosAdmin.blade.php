                                            ...
                                            <tr class="space_row_table" style="cursor: pointer;"
                                                ...
                                                <td class="text-center">
                                                    @if(($g->codigo_moneda ?? 'CRC') == 'CRC')
                                                        {{ number_format($g->total ?? '0.00', 2, '.', ',') }}
                                                    @else
                                                        {{ number_format($g->total ?? '0.00', 2, '.', ',') }} {{ $g->codigo_moneda ?? 'CRC' }}
                                                        <br><small class="text-muted">CRC {{ number_format(($g->total ?? 0) * ($g->tipo_cambio ?? 1.0000), 2, '.', ',') }}</small>
                                                    @endif
                                                </td>
                                                <td class="text-center">

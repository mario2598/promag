            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="usuario" name="usuario"
                                        onfocus="this.removeAttribute('readonly');" required maxlength="25">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="rol" name="rol">
                                    @foreach ($data['roles'] as $i)
                                        <option value="{{ $i->id }}">{{ $i->rol }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    Ingrese el precio por hora trabajada del usuario
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="form-group">
                                <input type="button" onclick="window.location='{{ URL::to('mant/usuarios') }}'" 
                                class="btn btn-warning" value="Volver a todos los usuarios">
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button type="buttom" onclick="cambiarContraDefault()" class="btn btn-info">Contraseña
                        Defecto</button>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/mantenimiento/mant_editar_usuarios.js') }}"></script>
@endsection
